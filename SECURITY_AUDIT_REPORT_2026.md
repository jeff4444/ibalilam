...
### LOW-003: Email Not Actually Sent

**Severity:** 🟢 Low  
**Location:** `app/api/contact-seller/route.ts` (lines 100-117)

**Description:**

The email is only logged to console, not actually sent:
...
- Broken functionality
- Poor user experience
- Users think emails are sent but they're not

**Recommendation:**

Implement actual email sending using a service like:
- Resend
- SendGrid
- AWS SES
- Postmark
...
### LOW-004: Hardcoded Category Hierarchy

**Severity:** 🟢 Low  
**Location:** `hooks/use-parts.ts` (lines 282-289)

**Description:**

Categories are hardcoded instead of fetched from database:
...
async function fetchCategoryHierarchy(_supabase: ReturnType<typeof createClient>) {
  ...
  return [
    ...
    { category: 'phone_parts', subcategories: ['screen', 'battery', ...] },
    // ...
  ]
}
```
...
- Inconsistency between database and frontend
- Difficult to maintain
- Changes require code deployment

**Recommendation:**

Create database table for categories or implement the RPC function.

**Priority:** P3 - Advisory

---

### LOW-005: Missing Security Headers
