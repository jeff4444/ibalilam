-- Fix the search_parts function parameter order issue
-- The issue is likely with how Supabase handles named parameters vs positional parameters

DROP FUNCTION IF EXISTS search_parts(TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, DECIMAL, DECIMAL, TEXT, BOOLEAN, TEXT, INTEGER, INTEGER);

-- Create a simpler version that accepts fewer parameters to avoid confusion
